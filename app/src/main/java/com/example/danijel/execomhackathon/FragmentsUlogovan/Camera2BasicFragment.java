...
import com.example.danijel.execomhackathon.MonumentActivity;
...
public class Camera2BasicFragment extends android.app.Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getExternalFilesDir(null), "pic"+seconds+""+minute+""+hour+""+day+""+mon+""+year+".jpg");
    ...
    private void unlockFocus() {
        try {
            ...
            mCaptureSession.setRepeatingRequest(mPreviewRequest, mCaptureCallback,
             ...
             Intent i = new Intent(getActivity(),MonumentActivity.class);
